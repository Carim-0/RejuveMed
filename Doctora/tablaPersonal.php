...
<body>
    <div class="header-container">
        <div class="container">
            <h1 class="text-center mb-0"><i class="fas fa-user-shield"></i> Personal Registrado</h1>
    ...
    <div class="container">
                        ...
                        <tbody>
                            <?php
                                while($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>";
                                    echo "<a href='editarPersonal.php?id=".$row['IDpersonal']."' class='action-link' title='Editar'><i class='fas fa-edit'></i> Editar</a>";
                                    echo "<a href='eliminarPersonal.php?id=".$row['IDpersonal']."' class='action-link delete' title='Eliminar' onclick='return confirm(\"¿Eliminar este miembro del personal?\")'><i class='fas fa-trash-alt'></i> Eliminar</a>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            ?>
        ...
        <div class="add-button">
            <button onclick="window.location.href='registrarPersonal.php'">
